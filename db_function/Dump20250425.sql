...
INSERT INTO `outstanding_balance` VALUES (6,10,3342978,150.50,'2025-04-05 22:29:36','close','2025-04-25 00:35:50');
...
BEGIN
    ...
    LEFT JOIN 
        moving_bazaar.billing b ON o.order_id = b.order_id
    WHERE 
        (in_order_status IS NULL OR in_order_status = '' OR o.order_status = in_order_status)
        AND (in_order_id IS NULL OR in_order_id = '' OR o.order_id LIKE CONCAT('%', in_order_id, '%'))
    LIMIT offset_val, in_page_size;
    
    -- Optional: handle no results at the application level (not here), or return count if needed
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    -- 5. Return success message and billing ID separately
    SELECT 'Billing successfully inserted.' AS message, billing_id;
...
-- Dump completed on 2025-04-25  0:37:37
