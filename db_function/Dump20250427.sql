...
INSERT INTO `documents` VALUES (1,1068025,'[\"path1.jpg\", \"path2.jpg\"]','2025-04-27 07:44:04','commodities');
...
BEGIN
    ...
    SELECT 
        ...
        sender.store_name AS senderStoreName,
        receiver.store_name AS receiverStoreName,
...
BEGIN
    ...
    INSERT INTO documents (order_id, paths, catagory)
    VALUES (inOrderId, inPaths, inCatagory);

    -- Get the auto-generated doc_id
    SET newDocId = LAST_INSERT_ID();

    -- Return the result
    SELECT 
        'Insertion successful' AS message,
        TRUE AS status,
        newDocId AS docId,
...
-- Dump completed on 2025-04-27 15:13:40
