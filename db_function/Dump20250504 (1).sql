...
INSERT INTO `billing` VALUES (3,3342978,1,4,267.00,467.00,250.00,50.00,200.00,'[1068025]','Partial','2025-04-24 18:30:51',NULL,'2025-04-12'),(4,1068025,1,4,267.00,467.00,250.00,50.00,200.00,'[3342978]','Partial','2025-04-24 18:41:53',NULL,'2025-04-12');
...
BEGIN
    ...
    -- Step 1: Return total count of matching draft orders (not in billing)
    SELECT 
    ...
    WHERE 
        b.order_id IS NULL  -- Exclude orders that already have billing
    ...
    -- Step 2: Return paginated draft order results (simplified)
    SELECT 
...
BEGIN
    ...
    JOIN 
        moving_bazaar.customer receiver ON o.receiver_id = receiver.customer_id
    JOIN 
        moving_bazaar.billing b ON o.order_id = b.order_id  -- changed from LEFT JOIN to INNER JOIN
    WHERE 
...
-- Dump completed on 2025-05-04 20:11:42
