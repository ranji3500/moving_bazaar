...
BEGIN
    ...
    DECLARE docId INT;
    DECLARE insertedDocIds TEXT DEFAULT '';
    ...
    WHILE i < pathCount DO
        ...
        -- Append the new doc ID to the list (comma-separated)
        IF insertedDocIds = '' THEN
            SET insertedDocIds = docId;
        ELSE
            SET insertedDocIds = CONCAT(insertedDocIds, ',', docId);
        END IF;
    ...
    SELECT 
        ...
        TRUE AS status,
        insertedDocIds AS documentIds,
        inOrderId AS orderId,
        pathCount AS insertedRows;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2025-05-01 17:37:05
