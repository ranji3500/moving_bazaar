...
INSERT INTO `billing` VALUES (4,1068025,1,4,499.99,'Paid','2025-04-12 06:30:00','receipt_12345.pdf',499.99,'2025-04-12');
...
INSERT INTO `outstanding_balance` VALUES (6,10,1068025,150.50,'2025-04-05 22:29:36','close','2025-04-06 20:48:51');
...
BEGIN
    SELECT 
        ...
        (
            SELECT JSON_ARRAYAGG(
                JSON_OBJECT(
                    ...
                    'quantity', oi.quantity,
                    'price', c.price,
                    'total_price', oi.quantity * c.price
                )
            )
            FROM moving_bazaar.order_items oi
            JOIN moving_bazaar.commodity c ON oi.commodity_id = c.commodity_id
        ...
        -- Grand total = order + outstanding
        (
            SELECT SUM(oi2.quantity * c2.price)
            FROM moving_bazaar.order_items oi2
            JOIN moving_bazaar.commodity c2 ON oi2.commodity_id = c2.commodity_id
            WHERE oi2.order_id = p_order_id
        ) + sender.outstanding_price AS grand_total
...
-- Dump completed on 2025-04-12 22:57:21
