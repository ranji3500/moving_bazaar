...
INSERT INTO `billing` VALUES (23,42465129,1,5,41960.00,41960.00,41960.00,41960.00,0.00,'[]','Paid','2025-06-01 14:33:45',NULL,'2025-06-01'),(24,4140411,1,5,3996.00,3996.00,3996.00,3996.00,0.00,'[]','Paid','2025-06-16 15:16:06',NULL,'2025-06-16');
...
INSERT INTO `customer` VALUES (5,'Vignesh Store','vignesh@example.com','12345678','12345678','123 Street','Area A','New York',1000.50,'2025-02-07 00:03:17',0),(31,'Spice Junction','spice.junction@exampljue.com','87654321','87654321','21, Linking Road','Bandra','Mumbai',12000.75,'2025-03-15 18:39:54',0);
...
INSERT INTO `orders` VALUES (318126,5,31,1,'In Transit','commodity','2025-05-26 17:30:31','2025-05-26 17:30:31',NULL,NULL),(4140411,5,31,1,'In Transit','billing','2025-06-01 14:34:14','2025-06-01 14:34:35',NULL,NULL),(10561754,5,31,1,'In Transit','commodity','2025-05-26 16:40:56','2025-05-26 16:40:56',NULL,NULL),(19042874,5,31,1,'In Transit','commodity','2025-05-26 16:49:04','2025-05-26 16:49:04',NULL,NULL),(32549917,5,31,1,'In Transit','commodity','2025-05-26 17:02:54','2025-05-26 17:02:54',NULL,NULL),(36559339,5,31,1,'In Transit','order','2025-05-20 17:06:55','2025-05-20 17:06:55',NULL,NULL),(38471864,5,31,1,'In Transit','commodity','2025-05-29 02:08:47','2025-05-29 02:08:47',NULL,NULL),(42149377,5,31,1,'In Transit','order','2025-05-20 17:12:14','2025-05-20 17:12:14',NULL,NULL),(42465129,31,5,1,'In Transit','billing','2025-05-29 17:12:46','2025-06-01 16:47:50',NULL,NULL),(48171109,5,31,1,'In Transit','commodity','2025-05-20 17:18:17','2025-05-20 17:18:17',NULL,NULL),(49180128,5,31,1,'In Transit','commodity','2025-05-20 17:19:18','2025-05-20 17:19:18',NULL,NULL),(49524049,5,31,1,'In Transit','commodity','2025-06-22 10:19:52','2025-06-22 10:19:52',NULL,NULL),(50023588,5,31,1,'In Transit','billing','2025-05-20 17:20:02','2025-06-22 10:12:09',NULL,NULL),(50089505,5,31,1,'In Transit','commodity','2025-06-22 10:20:08','2025-06-22 10:20:08',NULL,NULL),(51113761,5,31,1,'In Transit','commodity','2025-06-22 10:21:11','2025-06-22 10:21:11',NULL,NULL);
...
BEGIN
    ...
    WHERE 
        b.order_id IS NULL
        AND (inOrderStatus IS NULL OR inOrderStatus = '' OR o.order_status = inOrderStatus)
        AND (inOrderId IS NULL OR inOrderId = '' OR o.order_id LIKE CONCAT('%', inOrderId, '%'));

    -- Return total count (even if 0)
    SELECT totalRecords AS totalRecords;

    -- Step 2: Return paginated data or null row if no result
    IF totalRecords > 0 THEN
        ...
        WHERE 
            b.order_id IS NULL
            AND (inOrderStatus IS NULL OR inOrderStatus = '' OR o.stage = inOrderStatus)
            AND (inOrderId IS NULL OR inOrderId = '' OR o.order_id LIKE CONCAT('%', inOrderId, '%'))
...
BEGIN
    ...
    -- Step 1: Return total count of matching records
    SELECT 
        COUNT(*) INTO total
    FROM 
        orders o
    ...
    IF total > 0 THEN
        ...
        LIMIT offsetVal, inPageSize;
    ELSE
        -- Return one row with NULLs when no results are found
        SELECT  NULL;
...
BEGIN
    ...
    IF EXISTS (
        ...
        -- Conditionally include reason_id
...
-- Dump completed on 2025-06-29  9:47:45
